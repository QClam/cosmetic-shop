  ...
  return (
    <header className="bg-white shadow-md">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <nav className="flex justify-between items-center container mx-auto md:py-6 py-8">
            <Link><img src={logo} alt="" className="w-72 h-12"/></Link>
          ...
          <Link>
            <ShoppingCart size={54} className="rounded-full bg-gray-100 cursor-pointer px-3 py-2"/>
          </Link> 
        </nav>
      </div>
    </header>
